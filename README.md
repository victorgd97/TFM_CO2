...
**Outwards**: There are links to external material provided  both via href on top of text and also via icon click. 
...
Remaining improvements from general to details:
